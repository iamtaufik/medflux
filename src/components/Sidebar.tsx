    ...
    <div className={`w-1/5 min-h-screen bg-[#283342] py-7 flex  flex-col gap-8 fixed transition-all duration-300 ${isActive ? 'ml-0' : '-ml-[304px]'}`}>
      ...
      <div>
        <ul className="text-white">
          ...
          <li className={`cursor-pointer px-6 py-4 flex gap-4 items-center ${pathname === '/dashboard/suppliers' ? 'bg-primary' : ''}`}>
            <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
            ...
            <Link href="/dashboard/suppliers" className="w-full h-full">
              Suppliers
            </Link>
          </li>
