        ...
        <ul className="text-white">
          ...
          <li className={` ${pathname === '/dashboard/transaction' ? 'bg-primary' : ''} ${transactionIsOpen ? 'bg-black' : ''}`}>
            <div className=" flex gap-4 items-center">
              ...
              <div className="w-max h-max px-6" onClick={() => setTransactionIsOpen(!transactionIsOpen)}>
          ...
          <li className={` bg-black  ${transactionIsOpen ? 'block ' : 'hidden'}`}>
            <ul>
              <li className={`cursor-pointer py-4 ${pathname === '/dashboard/transaction/cashier' ? 'bg-primary' : ''}`}>
                <Link href={'/dashboard/transaction/cashier'} className="px-16">
                  Cashier
                </Link>
              </li>
              <li className={`cursor-pointer py-4 ${pathname === '/dashboard/transaction/data' ? 'bg-primary' : ''}`}>
