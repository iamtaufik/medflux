...
const TransactionModal = (props: ModalProps) => {
  ...
  return (
    <div className={`relative z-50 ${!isOpen && 'hidden'} `} aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div className=" min-w-screen fixed inset-0 z-10 ">
        <div className="flex  items-center justify-center min-h-full text-center sm:items-center sm:p-0">
          <div className="relative h-screen w-screen max-h-screen px-10 py-10  md:px-32 md:py-14  text-left transition-all transform  rounded-md shadow-xl ">
            {/* Content */}
