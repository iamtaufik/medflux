...
const Label = ({ title, value, icon, percentage }: IProps) => {
  return (
    <div className="px-4 py-3 bg-[#f1f7fd] max-w-xs w-full rounded-3xl h-full">
      ...
      <div className="flex gap-6 items-start">
        ...
        {percentage && (
          <div className="bg-[#0A9D4C] bg-opacity-10 px-2 rounded-xl flex items-center gap-1">
